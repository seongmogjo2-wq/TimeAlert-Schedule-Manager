...
final GoRouter router = GoRouter(
  ...
  routes: [
    ...
    GoRoute(path: '/alam', builder: (context, state) => const AlamScreen()),
    GoRoute(path: '/set', builder: (context, state) => const SetScreen()),
    GoRoute(path: '/add', builder: (context, state) => const AddScheduleScreen()),
  ],
);